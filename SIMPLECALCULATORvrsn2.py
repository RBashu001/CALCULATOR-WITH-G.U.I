...
def result():
    ...
    if oprt=='+':
        ...
        result=math.sqrt(oprnd2)
    elif oprt=='!':
        result=math.factorial(int(oprnd1))
    result_label.config(text=result)   
#UI PART....
#................
root=Tk()
root.title('Calculator')
root.geometry('350x380')#it fixes the initial appearance size of window
...
btnpt=Button(root,text='.',bg='#838B8B',fg="black",width='5',height='2',command=lambda: get_digit('.'))
btnpt.grid(row=4,column=1,sticky='w')
btnpt.config(font=('verdana',14))
#OPERATORS....
#................
...
btnpw=Button(root,text='x^y',bg='#838B8B',fg="black",width='5',height='2',command=lambda :get_oprtr("^"))
btnpw.grid(row=2,column=4,sticky='w')
btnpw.config(font=('verdana',14))
btnsqrt=Button(root,text='√x',bg='#838B8B',fg="black",width='5',height='2',command=lambda :get_oprtr("√"))
btnsqrt.grid(row=3,column=4,sticky='w')
btnsqrt.config(font=('verdana',14))
btnfct=Button(root,text='x!',bg='#838B8B',fg="black",width='5',height='2',command=lambda :get_oprtr("!"))
btnfct.grid(row=4,column=4,sticky='w')
btnfct.config(font=('verdana',14))
#anonomys....
#................
btneq=Button(root,text='=',bg='#838B8B',fg="black",width='5',height='2',command=lambda :result())
btneq.grid(row=4,column=2,sticky='w')
btneq.config(font=('verdana',14))
btnclr=Button(root,text='CLR',bg='#838B8B',fg="black",width='5',height='2',command=lambda: clr())
btnclr.grid(row=1,column=4,sticky='w')
